...
class GA(BatchPolopt):
    ...
    def train(self, runner):
        ...
        for itr in runner.step_epochs():
            ...
            reward_file.writelines("Iteration #" + str(itr) + "\n")
            reward_file.close()
            all_paths = {}
            for p in range(self.pop_size):
                paths_file = open("ga_paths.txt", "a")
                paths_file.writelines("Iteration #" + str(itr) + "\n")
                paths_file.writelines("Pop #" + str(p) + "\n")
                paths_file.close()

                crash_file = open("ga_crashes.txt", "a")
                crash_file.writelines("Iteration #" + str(itr) + "\n")
                crash_file.writelines("Pop #" + str(p) + "\n")
                crash_file.close()
